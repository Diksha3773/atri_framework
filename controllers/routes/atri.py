...
class Atri:
	def __init__(self, state: Any):
		...
		self.header_TextBox = state["header_TextBox"]
	...
	@property
	def header_TextBox(self):
		self._getter_access_tracker["header_TextBox"] = {}
		return self._header_TextBox
	@header_TextBox.setter
	def header_TextBox(self, new_state):
		self._setter_access_tracker["header_TextBox"] = {}
		global default_state
		self._header_TextBox = TextBox(new_state, default_state["header_TextBox"])
	...
	def _to_json_fields(self):
		return {
			...
			"header_TextBox": self._header_TextBox,
			"Link5": self._Link5,
			"Link7": self._Link7,
			"Link8": self._Link8,
			"Link9": self._Link9,
